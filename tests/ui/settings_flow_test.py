...
class SettingsFlowTest(BaseTest):
  ...
  This could be part of the setup page tests, but is abstracted away for now in case
  we ever decide to make the settings component its own page or move it off of setup.
  """
  ...
  def _getCurrentSettings(self):
    ...
    input_elements =  settings_holder.find_element(By.TAG_NAME, 'input')
    settings_dictionary = {}
