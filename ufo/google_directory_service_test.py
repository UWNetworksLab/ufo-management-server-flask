...
class GoogleDirectoryServiceTest(unittest.TestCase):
  ...
  @patch('google_directory_service.discovery.build')
  def setUp(self, mock_build):
    """Setup test object on which to call methods later on."""
    mock_build.return_value = MOCK_SERVICE
    self.directory_service = GoogleDirectoryService(MOCK_CREDENTIALS)
  ...
  def testInit(self, mock_build):
    ...
    google_directory_service = GoogleDirectoryService(MOCK_CREDENTIALS)
