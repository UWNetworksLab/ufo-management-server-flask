...
def _get_user_resources():
  ...
  return {
    ...
    'addFlowTextDicts': [
        ...
        {
          'id': 'userAdd',
          'tab': 'Search for Individual Users',
          'tabId': 'userAddTab',
          'saveButton': 'Add Users',
          'searchButton': 'Search for Individual User',
        ...
        {
          'id': 'domainAdd',
          'tab': 'View All Users in the Domain',
          'tabId': 'domainAddTab',
          'saveButton': 'Add Users',
